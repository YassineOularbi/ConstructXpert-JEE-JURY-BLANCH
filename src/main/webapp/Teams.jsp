    ...
    <div class="menu d-flex flex-column justify-content-between">
      <div class="first-option">
        <div class="menu-links">
          ...
          <a class="nav-link hovered my-2 active" href="teams">
      ...
      <div class="project-card card justify-content-between d-flex flex-column">
        <div class="dropdown">
          ...
          <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton">
            <li><a class="dropdown-item item-update" href="update-team?id=${team.getId()}">Update</a></li>
            <li><a class="dropdown-item" href="delete-team?id=${team.getId()}">Delete</a></li>
          </ul>
        </div>
        <img style="height: 200px;" src="${team.getPicture()}" class="card-img-top project-img" alt="Room Image">
        ...
        <div class="resource-head project-head d-flex flex-row justify-content-between align-items-center">
          <p>Job type : ${team.getJobType()}</p>
          <c:if test="${team.getAvailability() eq true}">
            <span>Available &#x2794;</span>
          </c:if>
          <c:if test="${team.getAvailability() eq false}">
