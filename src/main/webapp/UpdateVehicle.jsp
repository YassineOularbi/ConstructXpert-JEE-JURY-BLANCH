...
<section class=" main">
    ...
    <div class="create">
        <form action="update-vehicle" method="post" class="d-flex flex-row">
            <div class="resource-left resource">
                <div class="title">
                    <label for="title">Title :</label>
                    <i class="fa-solid fa-truck-front"></i>
                    <input type="text" id="title" class="title" name="title"
                           placeholder="Enter vehicle title " required value="${vehicle.getTitle()}">
                </div>
                <div class="type">
                    <label for="type">Type :</label>
                    <i class="fa-solid fa-dna"></i>
                    <input type="text" id="type" class="type" name="type"
                           placeholder="Enter vehicle type " required value="${vehicle.getType()}">
                </div>
                <div class="provider">
                    <label for="provider">Provider :</label>
                    <i class="fa-solid fa-store"></i>
                    <input type="text" id="provider" class="provider" name="provider"
                           placeholder="Enter resource provider " required value="${vehicle.getProvider()}">
                </div>
            </div>
            <div class="resource-right resource">
                <div class="acquisitionDate">
                    <label for="acquisitionDate">Acquisition Date :</label>
                    <input type="date" id="acquisitionDate" class="acquisitionDate" name="acquisitionDate" required value="${vehicle.getAcquisitionDate()}">
                </div>
                <div class="picture">
                    <label for="provider">Picture :</label>
                    <i class="fa-solid fa-image"></i>
                    <input type="url" id="picture" class="picture" name="picture"
                           placeholder="Enter resource picture " required value="${vehicle.getPicture()}">
                </div>
                <div class="quantity">
                    <label for="quantity">Quantity :</label>
                    <i class="fa-solid fa-layer-group"></i>
                    <input type="number" id="quantity" class="quantity" name="quantity"
                           placeholder="Enter resource quantity" required value="${vehicle.getQuantity()}">
                </div>
            </div>
            <button type="submit" class="btn resource-btn">Update</button>
                    <input hidden="hidden" value="${vehicle.getId()}" name="id">
        </form>
    </div>
</section>
