                ...
                <div class="up-left">
                    <div class="name">
                        ...
                        <input type="text" id="name" class="name" name="name"
                               placeholder="Enter project name " required value="${project.getName()}">
                    </div>
                    <div class="geolocation">
                        <label for="geolocation">Geolocation :</label>
                        <i class="fa-solid fa-location-crosshairs"></i>
                        <input type="text" id="geolocation" class="geolocation" name="geolocation"
                               placeholder="Enter project geolocation " required value="${project.getGeolocation()}">
                    </div>
                    <div class="description">
                        <label for="geolocation">Description :</label>
                        <i class="fa-solid fa-file-waveform"></i>
                        <input type="text" id="description" class="description" name="description"
                               placeholder="Enter project description " required value="${project.getDescription()}">
                    </div>
                </div>
                <div class="up-middle">
                    <div class="status">
                        ...
                        <select class="form-control" id="status" name="status" required>
                            <option></option>
                            <option ${project.getStatus() eq 'TODO' ? 'selected' : ''} value="TODO">Pending</option>
                            <option ${project.getStatus() eq 'IN_PROGRESS' ? 'selected' : ''} value="IN_PROGRESS">InProgress</option>
                            <option ${project.getStatus() eq 'COMPLETED' ? 'selected' : ''} value="COMPLETED">Completed</option>
                        </select>
                    </div>
                    <div class="dateStart">
                        <label for="dateStart">Date start :</label>
                        <input style="padding-left: 5px;" type="date" id="dateStart" class="dateStart" name="dateStart" required value="${project.getDateStart()}">
                    </div>
                    <div class="dateEnd">
                        <label for="dateEnd">Date end :</label>
                        <input style="padding-left: 5px;" type="date" id="dateEnd" class="dateEnd" name="dateEnd" required value="${project.getDateEnd()}">
                    </div>
                </div>
                <div class="up-middel-2">
                    <div class="Picture">
                        ...
                        <input type="url" id="picture" class="picture" name="picture"
                               placeholder="Enter project picture " required value="${project.getPicture()}">
                    </div>
                    <div class="planFloor">
                        <label for="planFloor">Plan floor :</label>
                        <i class="fa-regular fa-map"></i>
                        <input type="url" id="planFloor" class="planFloor" name="planFloor"
                               placeholder="Enter project plan floor" required value="${project.getPlanFloor()}">
                    </div>
                    <div class="room">
                        <label for="room">Room :</label>
                        <i class="fa-solid fa-person-booth"></i>
                        <input type="number" id="room" class="room" name="room"
                               placeholder="Enter project rooms " required value="${project.getRoom()}">
                    </div>
                </div>
                <div class="up-right">
                    <div class="bath">
                        ...
                        <input type="number" id="bath" class="bath" name="bath"
                               placeholder="Enter project bath " required value="${project.getBath()}">
                    </div>
                    <div class="garage">
                        <label for="garage">Garage :</label>
                        <i class="fa-solid fa-warehouse"></i>
                        <input type="number" id="garage" class="garage" name="garage"
                               placeholder="Enter project garage" required value="${project.getGarage()}">
                    </div>
                    <div class="terrace">
                        <label for="terrace">Terrace :</label>
                        <i class="fa-solid fa-mug-saucer"></i>
                        <input type="number" id="terrace" class="terrace" name="terrace"
                               placeholder="Enter project terrace " required value="${project.getTerrace()}">
                    </div>
                </div>
            </div>
                ...
                <div class="down-right">
                    ...
                    <div class="ligne pt-4">
                        ...
                        <div class="d-flex flex-row mt-3" style="gap: 10px;">
                            <label class="d-flex flex-row align-content-center"><input type="number" id="areaSize" class="areaSize" name="areaSize" required value="${project.getAreaSize()}">
                                <span style="margin-left: -30px;">m²</span>
                            </label>
                            <label class="d-flex flex-row align-content-center"><input type="number" id="budget" class="budget" name="budget" readonly value="${project.getBudget()}">
                                <span style="margin-left: -15px;">$</span>
                            </label>
                            <input hidden="hidden" value="${project.getId()}" name="id">
